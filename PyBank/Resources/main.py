...
budgetdata = os.path.join("Users", "aaronsummers", "python-challenge", "PyBank", "Resources","budget_data.csv")
...
budget = os.path.join("Analysis", "budget.txt")
with open(budget, "w") as outfile:
